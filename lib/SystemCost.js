  ...
  this.getTotalSystemCost = function(options, r, initialInvestment){
    ...
    return _.map(years, function(year) {
      return {
        ...
        cost: (function() {
          function costFor(balance, energyPrice, initialInvestment, energySellPrice) {
          ...
          var heating = _.chain(options.system.building).map(function(building) {
            ...
            switch (building.heatingSystem) {
              ...
              case "1":
                waterHeatingCost = costFor(annualWaterHeatingEnergyBalance, self.constants.heatingEnergyBuyPrices.districtHeating, 0, 0);
                spaceHeatingCost = costFor(annualSpaceHeatingEnergyBalance, self.constants.heatingEnergyBuyPrices.districtHeating, 0, 0);
                break;
              case "2":
                waterHeatingCost = costFor(annualWaterHeatingEnergyBalance, self.constants.heatingEnergyBuyPrices.oil, 0, 0);
                spaceHeatingCost = costFor(annualSpaceHeatingEnergyBalance, self.constants.heatingEnergyBuyPrices.oil, 0, 0);
                break;
              case "3":
                waterHeatingCost = costFor(annualWaterHeatingEnergyBalance, self.constants.electricityBuyPrice, 0, 0);
                spaceHeatingCost = costFor(annualSpaceHeatingEnergyBalance, self.constants.electricitySellPrice, 0, 0);
                break;
              case "4":
                waterHeatingCost = 0;
                spaceHeatingCost = 0;
          ...
          return costFor(annualElectricityBalance, self.constants.electricityBuyPrice, initialInvestment, self.constants.electricitySellPrice) + heating.space + heating.water
        })()
      };
    });
  };
